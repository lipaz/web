  ...
  function checkForm()
  {
    ...
    var confirmationTextElement = document.getElementById("confirmation");
   ...
   if(passwordTextElement.value.length < 6) {
    ...
    /*Confirmation*/
    if(confirmationTextElement.value.length < 6) {
        alert("Error: Password must contain at least six characters!");
        passwordTextElement.focus();
        return false;
      }
      ...
      re = /[0-9]/;
      if(!re.test(confirmationTextElement.value)) {
        alert("Error: password must contain at least one number (0-9)!");
        passwordTextElement.focus();
        return false;
      }
      ...
      alert("Success!\nUsername: " + usernameTextElement.value + "\nPassword: " + passwordTextElement.value +"\nconfirmation: "+confirmationTextElement.value);
      return true;
    }
